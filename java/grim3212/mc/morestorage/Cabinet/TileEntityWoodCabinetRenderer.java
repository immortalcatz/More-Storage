...
public class TileEntityWoodCabinetRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityWoodCabinet(TileEntityWoodCabinet tileentity, double x, double y, double z, float par8) {
		GL11.glPushMatrix();
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		renderTileEntityWoodCabinet((TileEntityWoodCabinet) par1TileEntity, par2, par4, par6, par8);
	}
}