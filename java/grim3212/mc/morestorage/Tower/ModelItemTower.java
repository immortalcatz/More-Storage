...
public class ModelItemTower extends ModelBase {
	...
	public ModelItemTower() {
		...
		ArrayList bottomy = new ArrayList();
		ArrayList bottomz = new ArrayList();
		ArrayList midy = new ArrayList();
		ArrayList midz = new ArrayList();
		ArrayList topy = new ArrayList();
		ArrayList topz = new ArrayList();
		float height = 0.0F;
		float length = 0.0F;
		...
		for (int i = 0; i < 100; i++) {
			...
			if ((i >= 30) && (i <= 70)) {
				...
				topz.add(Float.valueOf(10.0F - length * 7.0F));
			}
		...
		for (int i = 0; i < 100; i++) {
			...
			if ((i >= 30) && (i <= 70)) {
				...
				bottomz.add(Float.valueOf(3.0F + length * 7.0F));
			}
